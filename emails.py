...
REMINDER = """
It's time for daily work record.
"""
...
class OneReminderEmail(webapp.RequestHandler):
    def post(self):
        mail.send_mail(sender="snippets <snippets@bp-snippets.appspotmail.com>",
...
class OneDigestEmail(webapp.RequestHandler):
    ...
    def post(self):
        ...
        if body:
            self.__send_mail(user.email, 'https://bp-snippets.appspot.com\n\n' + body)
        else:
